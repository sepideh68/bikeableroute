...
////////////gyroscope///////////////////////
	            ...
	            promise = $deviceGyroscope.getCurrent();
...
////////////gyroscope///////////////////////				
				...
				var dateGPS_1 = position.timestamp;		
					pointId +=1;
					storeTrack(trackid_1, pointId, $scope.uuid, dateGPS_1, lat_1, lng_1, alti,resultXYZ.x,resultXYZ.y,resultXYZ.z,0,"NA",gyro_x,gyro_y,gyro_z);			 
				$scope.$apply();
